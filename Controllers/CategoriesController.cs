...
namespace ApiEcommerce.Controllers
{
    ...
    public class CategoriesController : ControllerBase
    {
        ...
        public IActionResult CreateCategory(CreateCategoryDto createCategoryDto)
        {
            ...
            {
                ModelState.AddModelError("CustomError", "Category exists");
            ...
            {
                ModelState.AddModelError("CustomError", "Category didn't create");
        ...
        {
            if (!_categoryRepository.CategoryExist(id)) return NotFound("Category doesn't exist");
            ...
            {
                ModelState.AddModelError("CustomError", "Category was not updated");
                return StatusCode(500, ModelState);
            }
        ...
        public IActionResult DeleteCategory(int id)
        {
            ...
            if (category == null) NotFound($"La categoría con el {id} no existe");

            if (!_categoryRepository.DeleteCategory(category))
            {
                ModelState.AddModelError("CustomError", "Category was not removed");
                return StatusCode(500, ModelState);
            }
